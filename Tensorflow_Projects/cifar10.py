...
model = tf.keras.models.Sequential([
    ...
    layers.Conv2D(16,(3,3),1,activation='relu',input_shape=(32,32,3)),
    layers.MaxPooling2D(),
    layers.Conv2D(32,(4,4),1,activation='relu'),
    layers.MaxPooling2D(),
    layers.Flatten(),
    layers.Dropout(0.2),
...
data = model.fit(x_train,y_reshape_train,epochs=10,batch_size=128,validation_data=(x_test,y_reshape_test))
